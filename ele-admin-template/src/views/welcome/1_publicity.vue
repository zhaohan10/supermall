      ...
      <el-main>
        ...
        <div class="table" style="overflow: hidden">
          <el-table
            ...
            stripe
          >
            <el-table-column prop="title" label="公示内容" align="left">
        ...
        <pub-dialog :isPubShow="isPubShow" :pubDetail="pubDetail"></pub-dialog>
      </el-main>
    </el-container>
  </div>
</template>
...
<script>
  ...
  import pubDialog from './pubDialog.vue';
  import searchForm from './components/search-form.vue';
  import { detailList2, tableData2 } from './mock';
  export default {
    name: 'publicity',
    components: { pubDialog, searchForm },
    data() {
      return {
        tableData2, //表格数据，应为页面创建时获取到
        detailList2, //竞聘详情
        userInfo: {},
        dailyMessage: {},
        expandMore: false,
