      ...
      <el-col :md="12">
        <el-card shadow="never" header="基础演示">
          ...
          <div style="margin-bottom: 10px" class="ele-action-group">
            <el-button @click="play" size="mini" :disabled="!ready1">
              播放
            </el-button>
            <el-button @click="pause" size="mini" :disabled="!ready1">
              暂停
            </el-button>
            <el-button @click="replay" size="mini" :disabled="!ready1">
              重新播放
            </el-button>
            <el-button @click="changeSrc" size="mini" :disabled="!ready1">
              切换视频源
            </el-button>
          </div>
          <!-- 播放器 -->
          <xgplayer :config="config1" @player="onPlayer1" />
        </el-card>
      </el-col>
      <el-col :md="12">
        <el-card shadow="never" header="显示弹幕">
          ...
          <div style="margin-bottom: 10px" class="ele-action-group">
            ...
            <el-button @click="shoot" size="mini" :disabled="!ready2">
              发射
            </el-button>
          </div>
          <!-- 播放器 -->
          <xgplayer :config="config2" @player="onPlayer2" />
        </el-card>
      </el-col>
    </el-row>
  </div>
